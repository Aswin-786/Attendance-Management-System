...
import ViewStaff from "./ViewStaff"; // Import the ViewStaff component
import { BASE_URL } from "../shared/config";

const StaffList = () => {
  const [workers, setWorkers] = useState([]);
  const [selectedUserId, setSelectedUserId] = useState(null); // State to store the selected userId
  ...
  const handleButtonClick = (userId) => {
    setSelectedUserId(userId); // Set the selected userId when button is clicked
  };
